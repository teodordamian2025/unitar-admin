...
Probleme actuale:
1a.La Editare factura, la factura pdf care face automat, in partea de jos la avem o nota:"Cursuri BNR (din frontend - FARA recalculare): Curs valutar BNR: 1 GBP = 5.8856 RON (2025-08-16), 1 EUR = 5.0628 RON (2025-08-16), 1 USD = 4.3331 RON (2025-08-16)", aceasta este corecta, si mai este o nota dedesubt care este incorecta pentru ca are cursurile valutare ale subproiectelor din BD de la data proiectului: "Observatii:Curs valutar BNR: 1 GBP = 5.8297 RON ([object Object]), 1 EUR = 5.0704 RON ([object Object]), 1 USD = 4.3443 RON ([object Object])". A doua nota trebuie sa fie scoasa din pdf.
1b. Tot la Editare factura, la meniulde Edit factura, la rubrica de jos "📝 Observații (opțional)" este precompletat Curs valutar BNR: 1 GBP = 5.8297 RON ([object Object]), 1 EUR = 5.0704 RON ([object Object]), 1 USD = 4.3443 RON ([object Object])", ar trebuie sa fie ca la meniul "Genereaza Factura PDF" unde la acea rubrica este un text in umbra ca exemplu "Observații suplimentare pentru factură" iar utilizatorul poate sa scrie observatii.
1c. La pagina https://admin.unitarproiect.eu/admin/rapoarte/facturi, Lista de facturi as vrea sa o optimizam vizual, acum e o singura culoare la lista si e greu de urmarit la butoanele de actiuni. As vrea sa folosim 3 culori deschise combinatii intre gri si crem, la 3 randuri sa folosim cate o culoare diferita la fiecare rand, iar acest pachet de 3 culori sa se repete mai jos la toate celelalte randuri cate 3 culori.
1d. La pagina https://admin.unitarproiect.eu/admin/rapoarte/facturi butonul de acțiuni PDF ar trebui sa regenereze pdf conform bazei de date, problema este ca vizul arata total diferit de facatura pdf de la meniul "Genereaza Factura PDF" sau de la "Edit". Ar trebui sa copieze cumva exact acelasi model de afisare pentru pdf ca la "Edit".
1e. La pagina https://admin.unitarproiect.eu/admin/rapoarte/facturi poate ar fi mai bine ca la coloana Acțiuni sa strangem butoanele de actiuni intr-un dropdown. Ca sa nu reinventam dropdown-ul as vrea sa se copieze modelul de la pagina https://admin.unitarproiect.eu/admin/rapoarte/proiecte, fara Glassmorthism, dar sa aiba acelasi comportament de a se afisa peste randuri, coborare sau urcare in functie de locul pe ecran.
