                        ...
                        >
                          {editingAlocare?.id === p.id ? (
                            ...
                            <div>
                              ...
                              {/* Checkbox pentru înregistrare timp în formular editare - ascuns */}
                              <div style={{ marginBottom: '0.75rem' }}>
                                <label style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block', marginBottom: '4px' }}>
                                  Prioritate
                                </label>
                              ...
                              <div style={{
                                ...
                                {timeEntriesPerAlocare[p.id] && timeEntriesPerAlocare[p.id].length > 0 && (
                                  <span style={{
                                    ...
                                    Inregistrat {timeEntriesPerAlocare[p.id].reduce((a, b) => a + b, 0)}h
                                    {timeEntriesPerAlocare[p.id].length > 1
                                      ? `(${timeEntriesPerAlocare[p.id].map(e => `${e}h`).join('+')})`
                                      : ''}
                                  </span>
                                )}
                              </div>
