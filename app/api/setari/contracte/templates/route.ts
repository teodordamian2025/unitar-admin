...
// Funcție helper pentru citirea conținutului template-ului
...
// Funcție helper pentru obținerea căii complete a template-ului  
export function getTemplatePath(templateId: string): string {
  return path.join(TEMPLATES_DIR, `${templateId}.docx`);
}

// Funcție helper pentru găsirea celui mai potrivit template pentru un tip de document
