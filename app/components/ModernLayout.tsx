...
const navStructure: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/admin/analytics/planning-overview', label: 'Planning Overview', icon: '👥' },
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/admin/financiar/chitante', label: 'Chitante', icon: '🧾' },
      ...
      { href: '/admin/financiar/cheltuieli', label: 'Cheltuieli Subcontractanți', icon: '🧾' }
    ]
  },
  {
    href: '/admin/setari',
    ...
    children: [
      ...
      { href: '/admin/setari/email-connect', label: 'Email Connect', icon: '📧' }
    ]
  }
];
